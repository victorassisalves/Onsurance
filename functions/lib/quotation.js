    ...
    return new Promise((resolve, reject) => {
        ...
        const calcAnualOnsurance = (minute_value) => {
            ...
            const quotation_data = {
                ...
                private_api: Object.assign({}, data_set, { credit_duration: credit_duration, insurance_calc: insurance_calc, economy_cot: economy, minute_value_cot: minute_value_rs, anual_protection_value_cot: anual_onsurance_value, min_credit_cot: credit_min.toFixed(2), franchise_cot: franchise })
            };
