...
exports.protection = functions.https.onRequest((request, response) => __awaiter(this, void 0, void 0, function* () {
...
exports.createProfile = functions.https.onRequest((request, response) => __awaiter(this, void 0, void 0, function* () {
    ...
    const getVariables = require(`./messengerVariables.js`);
    // User variables and data
    const systemVariables = yield getVariables.getSystemVariables(request);
    ...
    yield calcMin.calcMinCar(vehicleVariables.carValue).then(result => {
...
exports.usageReport = functions.https.onRequest((request, response) => {
    ...
    let report;
    // Get protection status (User and vehicle Profiles)
    const GETPROFILES = () => __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
    ...
    function generateReport(userProfile, vehicleProfile) {
        ...
        const transferProfile = (userProfile, vehicleProfile) => {
            return new Promise((resolve, reject) => {
                ...
                const iterateArrayVehicle = (vehicle, userEmail, indice) => __awaiter(this, void 0, void 0, function* () {
                    // Data base reference call
                    ...
                    if (vehicleDbId === true) {
                        const valorConsumidoUser = logUseArray.reduce((prevVal = 0, elem) => {
                            if (elem !== null) {
                        ...
                        const userUsage = logUseArray.reduce((prevVal = 0, elem) => {
                            if (elem !== null) {
                        ...
                        const remaining_credit = (userProfile[`${arrayKeysUser[indice]}`].personal.wallet.switch);
                ...
                const iterateArrayUser = (item, indice, array) => __awaiter(this, void 0, void 0, function* () {
                    // Data base reference call
                    ...
                    if (vehiclePlate !== "false") {
                        ...
                        log('vehicle: ', vehicle);
                        yield iterateArrayVehicle(vehicle, userEmail, indice);
...
exports.updateDb = functions.https.onRequest((request, response) => {
    ...
    const transferProfile = () => {
        return new Promise((resolve, reject) => {
            ...
            const iterateArrayVehicle = (item, indice, array) => __awaiter(this, void 0, void 0, function* () {
                log(`Item: ${item}`);
                log(`Indice: ${indice}`);
                const oldId = item;
                log('oldId: ', oldId);
